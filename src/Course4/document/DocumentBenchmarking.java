...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
	    ...
	    // The text to test on
	    String textfile = "data/data/warAndPeace.txt";
				...
				numToCheck += increment)
		{
			...
			double beforeLoop = System.nanoTime() / 10e9;
			for(int t = 0;t < trials ; t++)
			{
				BasicDocument bd = new BasicDocument(textfile);
				bd.getFleschScore();
			}
			System.out.print(System.nanoTime() / 10e9 - beforeLoop + "\t");

			beforeLoop = System.nanoTime() / 10e9;
			for(int t = 0;t < trials ; t++)
			{
				EfficientDocument bd = new EfficientDocument(textfile);
				bd.getFleschScore();
			}
			System.out.println(System.nanoTime() / 10e9 - beforeLoop);
